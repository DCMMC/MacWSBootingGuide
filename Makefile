...
# iOS subprojects
SUBPROJECTS += MTLCompilerBypassOSCheck MacWSWindowing MTLSimDriverHost launchdchrootexec autosignd macwsallocd macwshostd macwsthermal mountdevfs ViewBridgeChrootProxy mtl_keepalive MacWSHost misc/PingMTLCompilerService
# macOS subprojects
